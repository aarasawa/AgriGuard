...
import { Map as MapIcon, Database, Leaf, Menu, X, LogIn, LogOut, User } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-slate-900 tracking-tight">PestiMap</span>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            {user ? (
              ...
              <button
                onClick={handleLogin}
                className="ml-2 px-4 py-2 bg-slate-900 text-white rounded-lg text-sm font-medium hover:bg-slate-800 transition-all flex items-center gap-2"
              >
          ...
          <div className="pt-2 border-t border-slate-100">
            {user ? (
              <button
                ...
                className="w-full px-4 py-3 rounded-xl text-base font-medium text-red-600 hover:bg-red-50 flex items-center gap-3"
              >
                <LogOut className="w-5 h-5" />
                Logout
              </button>
              ...
              <button
                ...
                className="w-full px-4 py-3 rounded-xl text-base font-medium text-slate-900 hover:bg-slate-50 flex items-center gap-3"
              >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row justify-between items-center gap-6">
              <div className="flex items-center gap-2">
                ...
                <span className="text-lg font-bold text-slate-900">PestiMap</span>
              </div>
              <p className="text-sm text-slate-500">
                &copy; 2024 PestiMap PUR Data Explorer. All rights reserved.
              </p>
